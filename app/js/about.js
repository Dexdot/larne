...
document.querySelector('html').classList.add('page-about');
...
$(window).on('load', function () {
  if ($('html').hasClass('page-about')) {
    ...
    var $texts = $('.about__quote, .about__author');
    var $author = $('.about__author');

    _gsap2.default.set([$texts], { transition: '1s ease' });
    _gsap2.default.set([$author], { transition: '1s ease 0.3s' });
