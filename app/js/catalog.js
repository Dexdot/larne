...
var _cutString = __webpack_require__(56);
...
$(window).on('DOMContentLoaded resize', function () {
  if (window.innerWidth <= 750) {
    var $names = $('.catalog-item__name');
    $names.each(function (i, name) {
      var shortName = (0, _cutString2.default)(name.textContent, 44);
      if (shortName) {
        $(name).text(shortName);
      }
    });
...
var $filterClose = $('.filter-overlay, .filter__close');
var $filterShow = $('.catalog__btn--filter');
...
// Показать больше
var $moreBtn = $('.filter__btn-more');
$moreBtn.on('click', function onMoreBtnClick() {
  var type = this.dataset.filter;
  $('.filter__column--hidden[data-filter=' + type + ']').removeClass('filter__column--hidden');
...
$btn.on('click', function () {
  return $sort.toggleClass('sort--is-visible');
});
...
exports.default = function (str, maxlen) {
...
var _catalogItems = __webpack_require__(53);

var _catalogItems2 = _interopRequireDefault(_catalogItems);
...
var $grid = $('.catalog__list');

$(window).on('load', function () {
  if (window.innerWidth > 750) {
    $grid.masonry(config).masonry('layout').masonry('reloadItems');

    (0, _catalogItems2.default)();
  } else {
    (0, _catalogItems2.default)();
  }
});
...
exports.default = window.Masonry;
...
document.querySelector('html').classList.add('page-catalog');
