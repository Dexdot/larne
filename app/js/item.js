...
exports.default = { disable: disable, enable: enable };
...
var _stopScroll = __webpack_require__(1);
...
var _helpTabs = __webpack_require__(5);

var _helpTabs2 = _interopRequireDefault(_helpTabs);
...
var $help = $('.help');
var $helpBtn = $('.footer__btn--help');
var $helpClose = $('.help__close, .help .hamburger');

var $heroCover = $('.hero-cover');

var showHelp = function showHelp() {
  _stopScroll2.default.disable();
  $heroCover.addClass('z1');
  $help.addClass('help--is-visible');
};
var hideHelp = function hideHelp() {
  _stopScroll2.default.enable();
  $heroCover.removeClass('z1');
  $help.removeClass('help--is-visible');
};

$helpBtn.on('click', function onHelpBtnClick() {
  var type = $(this).attr('data-help');

  _helpTabs2.default.deactivateTabs();
  _helpTabs2.default.activateTab(type);
  _select2.default.help.set(type);

  _helpTabs2.default.hideContents();
  _helpTabs2.default.showContent(type);

  showHelp();
});
$helpClose.on('click', hideHelp);

exports.default = { showHelp: showHelp, hideHelp: hideHelp };
...
var _slimSelect = __webpack_require__(30);
...
var $payment = $('.payment__type');
if ($payment.length) {
  $payment.each(function (i, select) {
    var slimSelect = new _slimSelect2.default({
      select: select,
      showSearch: false
    });
...
// Хелп
var $help = $('.help__select');
var help = void 0;
if ($help.length) {
  $help.each(function (i, select) {
    help = new _slimSelect2.default({
      select: select,
      showSearch: false
    });
    selects.push(help);
...
// Тип оплаты в ЛК
var $profilePayment = $('.profile__select');
if ($profilePayment.length) {
  $profilePayment.each(function (i, select) {
    var slimSelect = new _slimSelect2.default({ select: select, showSearch: false });
    selects.push(slimSelect);

    // Показ инпутов кредитки, если выбран "Банковская карта"
    var $form = $('.profile__block--payment .profile-form');
    var isBank = function isBank(type) {
      if (type === 'bank') {
...
const TimelineLite = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].TimelineLite;
...
var $contents = $('.help__content');
var $tabs = $('.help__tab');
var $select = $('.help__select');

var deactivateTabs = function deactivateTabs() {
  return $tabs.removeClass('help__tab--is-active');
};
var activateTab = function activateTab(type) {
  return $('.help__tab[data-help=' + type + ']').addClass('help__tab--is-active');
};

var hideContents = function hideContents() {
  return $contents.hide();
};
var showContent = function showContent(type) {
  return $('.help__content--' + type).show();
};

$tabs.on('click', function onHelpTabClick() {
  var $tab = $(this);
  var type = $tab.attr('data-help');
...
var _reg = __webpack_require__(7);
...
var $menuLogin = $('.menu__login');

var $loginClose = $login.find('.login__close, .login__overlay');
var $signup = $login.find('.login__signup');
...
exports.default = { showLogin: showLogin, hideLogin: hideLogin };
...
var _recovery = __webpack_require__(17);
...
var $reg = $('.reg');
var $regClose = $reg.find('.reg__close, .reg__overlay');
var $signin = $('.reg__signin');
var $back = $reg.find('.reg__btn--back');
var $policy = $('.reg__policy-link');

var hideReg = function hideReg() {
  _stopScroll2.default.enable();
  $reg.removeClass('reg--is-visible');
  $regClose.off('click', hideReg);
};
var showReg = function showReg() {
  _stopScroll2.default.disable();
...
$signin.on('click', function () {
  hideReg();
  _recovery2.default.hideRecovery();
  _login2.default.showLogin();
});
...
exports.default = { showReg: showReg, hideReg: hideReg };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TimelineMax_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__TweenMax_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__CSSPlugin_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__AttrPlugin_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RoundPropsPlugin_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__DirectionalRotationPlugin_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(15);
...
const TimelineMax = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].TimelineMax;
...
const CSSPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].CSSPlugin;
...
const AttrPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */]._gsDefine.plugin({
	propName: "attr",
	API: 2,
	version: "0.6.1",
...
const RoundPropsPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */]._gsDefine.plugin({
				propName: "roundProps",
				version: "1.7.0",
				priority: -1,
				API: 2,
...
const DirectionalRotationPlugin = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */]._gsDefine.plugin({
...
const Back = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Back;
/* harmony export (immutable) */ __webpack_exports__["a"] = Back;

const Elastic = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Elastic;
/* harmony export (immutable) */ __webpack_exports__["d"] = Elastic;

const Bounce = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Bounce;
/* harmony export (immutable) */ __webpack_exports__["b"] = Bounce;

const RoughEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].RoughEase;
/* harmony export (immutable) */ __webpack_exports__["g"] = RoughEase;

const SlowMo = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].SlowMo;
/* harmony export (immutable) */ __webpack_exports__["i"] = SlowMo;

const SteppedEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].SteppedEase;
/* harmony export (immutable) */ __webpack_exports__["j"] = SteppedEase;

const Circ = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Circ;
/* harmony export (immutable) */ __webpack_exports__["c"] = Circ;

const Expo = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Expo;
/* harmony export (immutable) */ __webpack_exports__["e"] = Expo;

const Sine = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].Sine;
/* harmony export (immutable) */ __webpack_exports__["h"] = Sine;

const ExpoScaleEase = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].ExpoScaleEase;
...
var $catalogBtn = $('.menu__link--catalog');
var $nav = $('.menu__nav');
var $btm = $('.menu__btm');

var $catalog = $('.menu__catalog');
var $back = $('.menu__back');

var showMenuCatalog = exports.showMenuCatalog = function showMenuCatalog() {
  $btm.hide();
  $back.show();
...
var hideMenuCatalog = exports.hideMenuCatalog = function hideMenuCatalog() {
  $back.hide();
  $btm.show();
...
var $recovery = $('.recovery'); // Анимация и показ "Восстановление пароля"

var $recoveryBtn = $('.login__recovery');
var $recoveryClose = $recovery.find('.recovery__close, .recovery__overlay');

var hideRecovery = function hideRecovery() {
  _stopScroll2.default.enable();
  $recovery.removeClass('recovery--is-visible');
  $recoveryClose.off('click', hideRecovery);
};
var showRecovery = function showRecovery() {
  _login2.default.hideLogin();
  _reg2.default.hideReg();
  _stopScroll2.default.disable();
...
exports.default = { showRecovery: showRecovery, hideRecovery: hideRecovery };
...
var $checkout = $('.checkout'); // Анимация и показ всего чекаута

var $checkoutBtn = $('.header__cart');
var $checkoutClose = $checkout.find('.checkout__close, .checkout__overlay');

var hideCheckout = function hideCheckout() {
  _stopScroll2.default.enable();
...
exports.default = { showCheckout: showCheckout, hideCheckout: hideCheckout };
...
var $tabs = $('.checkout__tab');
var $forms = $('.checkout__form');
...
var _showForm = function _showForm(form) {
  return $('.checkout__form--' + form).show();
};
...
// Принимает строку
var activateTab = function activateTab(type) {
  return $('.checkout__tab--' + type).addClass('checkout__tab--is-active');
};
...
$tabs.on('click', function onCheckoutTabClick() {
  ...
  var prev = $tab.siblings('.checkout__tab--is-active').index();
...
// EXPORT
exports.default = { hideForms: hideForms, showForm: _showForm, deactivateTabs: deactivateTabs, activateTab: activateTab };


$(window).on('load', function () {
  window.checkout = _extends({}, window.checkout, {
    showForm: function showForm(formName) {
      hideForms();
      deactivateTabs();

      if (formName === 'cart-empty') {
        activateTab('cart');
      } else if (formName === 'reg' || formName === 'login' || formName === 'recovery' || formName === 'success') {
        activateTab('reg');
    ...
    next: function next() {
      var type = $('.checkout__tab--is-active').next().attr('data-tab');
...
$(window).on('load', function () {
  ...
  var isMainPage = $('html').hasClass('page-main');

  var $p = $('.preloader');
  var w = $('.preloader__white')[0];
  ...
  var ease = _gsap.Power2.easeInOut;

  if (isMainPage) {
    var img = $('.hero-image').first()[0];

    var clearTransform = function clearTransform() {
      _gsap.TweenMax.set(img, { clearProps: 'transform' });
    };

    // Для анимации текстов
    var $texts = $('.hero__title, .hero__subtitle');
    if ($texts.length) {
      $texts.addClass('hero-text-anim');
    }

    // Прячем текст и начинаем анимацию прелоадера
    _gsap.TweenMax.set('.hero-text-anim', { opacity: 0, x: '10%' });
    tl.to(w, 0.6, { x: '0%', ease: ease }, '+=1.4').to($p[0], 0.6, {
      x: '-100%',
      ease: ease,
      onComplete: destroy
    }, '-=0.2').fromTo(img, 0.8, { x: '5%', ease: _gsap.Power3.easeInOut }, {
      x: '0%',
      onComplete: clearTransform
    }, '-=0.4').staggerTo('.hero-text-anim', 0.8, { opacity: 1, x: '0%' }, 0.15, '-=0.6');
  } else {
    tl.to(w, 0.6, { x: '0%', ease: ease }).to($p[0], 0.6, {
      x: '-100%',
      ease: ease,
      onComplete: destroy
    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(15);
...
const TweenMax = __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__["k" /* _gsScope */].TweenMax;
/* unused harmony export TweenMax */
...
var onInputFocus = function onInputFocus() {
  $(this).parent().addClass('input__label--is-focused');
};
var onInputFocusout = function onInputFocusout() {
  $(this).parent().removeClass('input__label--is-focused');

  var val = $(this).val();

  if (val) {
    $(this).parent().addClass('input__label--is-filled');
  } else {
    $(this).parent().removeClass('input__label--is-filled');
  }
};
...
$input.each(function (i, input) {
  ...
  if (val) {
    $(input).parent().addClass('input__label--is-filled');
  } else {
    $(input).parent().removeClass('input__label--is-filled');
  }
});
...
var showTip = function showTip(input) {
  $(input).closest('.input').find('.input__tip--basic').fadeIn();
};
var hideTip = function hideTip(input) {
  $(input).closest('.input').find('.input__tip--basic').fadeOut();
};

// Показываем / прячем красный тип
var showDangerTip = function showDangerTip(input) {
  $(input).closest('.input').find('.input__tip--danger').fadeIn();
};
var hideDangerTip = function hideDangerTip(input) {
  $(input).closest('.input').find('.input__tip--danger').fadeOut();
};

// Задаем красное подчеркивание и показываем красный тип
var setDanger = function setDanger(input) {
  $(input).parent().addClass('input__label--danger');

  showDangerTip(input);
};
var unsetDanger = function unsetDanger(input) {
  $(input).parent().removeClass('input__label--danger');
...
exports.default = {
  showTip: showTip,
  hideTip: hideTip,
  showDangerTip: showDangerTip,
  hideDangerTip: hideDangerTip,
  setDanger: setDanger,
  unsetDanger: unsetDanger
};
...
var $inputMailing = $('.input__label--mailing .input__field');
var $arrowBtn = $inputMailing.parent().find('.input__btn');
...
$inputMailing.on('focus', function onInputMainlingFocus() {
  $(this).parent().addClass('input__label--no-placeholder');
});
$inputMailing.on('focusout', function onInputMainlingKFocusout() {
  $(this).parent().removeClass('input__label--no-placeholder');
});
...
var $checkbox = $('.checkbox:not(.js-radio)');
...
var onInputClick = function onInputClick() {
  $(this).closest('.checkbox').toggleClass('checkbox--is-checked');
};

$checkbox.on('click', onCheckboxClick);
$input.on('change', onInputClick);

var $radio = $('.checkbox.js-radio');
$radio.on('click', onCheckboxClick);

var $payment = $('.payment');
var $paymentRadio = $payment.find('.checkbox.js-radio');
var $paymentInput = $payment.find('.checkbox.js-radio input');

$paymentInput.on('change', function onPaymentInputClick() {
  $paymentRadio.removeClass('checkbox--is-checked');

  $(this).closest('.checkbox').addClass('checkbox--is-checked');
});
...
var $searchBtn = $('.header__search, .notfound__search');
var $menuSearch = $('.menu__search');

var $searchInput = $search.find('.input__field');
...
var scrollStartStop = function scrollStartStop() {
  var _this = this;
...
$(document).ready(function () {
  ...
  var $subscribeBtn = $('.footer__btn--subscribe');
  var $subscribeOverlay = $('.subscribe__overlay');

  var $wrapper = $('.main-wrapper');
  var $footer = $('.footer--last');

  var showSubscribe = function showSubscribe() {
    _stopScroll2.default.disable();
    $subscribe.addClass('subscribe--is-visible');
    $wrapper.addClass('main-wrapper--up');
    $footer.addClass('footer--up');
  };
  var hideSubscribe = function hideSubscribe() {
    _stopScroll2.default.enable();
...
var $link = $('.header__list-item:first-child');
var $header = $('.header');

var showCatalog = function showCatalog() {
  $header.addClass('header--catalog-drop');
};
var hideCatalog = function hideCatalog() {
...
var _getChar = __webpack_require__(36);

var _getChar2 = _interopRequireDefault(_getChar);

var _cardType = __webpack_require__(37);

var _cardType2 = _interopRequireDefault(_cardType);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var $card = $('.credit-card'); // Обработка ввода кредитки

var $icons = $card.find('svg');
var $iconCard = $card.find('.i-card');
var $iconVisa = $card.find('.i-visa');
var $iconMaster = $card.find('.i-mastercard');
var $iconMir = $card.find('.i-mir');

var $number = $card.find('.credit-card__number');
var $expiry = $card.find('.credit-card__expiry');
var $csc = $card.find('.credit-card__csc');

var numberNotSelected = true;

var showIcon = function showIcon(icon) {
...
$number.on('keyup change', function () {
  ...
  if (val.length >= 0) {
    var type = (0, _cardType2.default)(val);
...
$number.on('keydown change', function (e) {
  ...
  var onlyNum = key > 47 && key < 58 || key > 95 && key < 106;
...
// CSC
$csc.on('keydown change', function (e) {
  var val = $csc.val();
  var key = e.originalEvent.keyCode;
...
var $number = $('.credit-card__number');
var $expiry = $('.credit-card__expiry');
var $csc = $('.credit-card__csc');

// Functions
var GetCharacterFromKeyCode = function GetCharacterFromKeyCode(key) {
...
var correctStoredNumber = function correctStoredNumber(s) {
  var corrected = '';
  var partA = A(s);
...
var setCursorPosition = function setCursorPosition(element, pos) {
...
$expiry.on('click focus', function () {
  var element = $expiry[0];

  var _$expiry$val = $expiry.val(),
      length = _$expiry$val.length;

  setCursorPosition(element, length);
});
$expiry.on('keydown change', function (e) {
  var val = $expiry.val();
  var key = e.which;
  var onlyNum = key > 47 && key < 58 || key > 95 && key < 106;
...
// Вспомогательный модуль для ввода только чисел
...
var mapCenter = { lat: 59.929714, lng: 30.354871 };
var mapStyles = [{
  featureType: 'all',
...
var iconUrl = '/img/map-icon.svg';

$(window).on('load', function () {
  // Карта в чекауте (Доставка)
  var deliveryMap = document.querySelector('.delivery__map');
  var initDeliveryMap = function initDeliveryMap() {
    // eslint-disable-next-line
    var map = new window.google.maps.Map(deliveryMap, _extends({}, mapSettings, {
      center: mapCenter,
      zoom: 16
    }));
    ...
    var locations = [{ lat: 59.929714, lng: 30.354871 }];
  ...
  var initContactsMap = function initContactsMap() {
    var map = new window.google.maps.Map(contactsMap, _extends({}, mapSettings, {
      center: mapCenter,
      zoom: 15
    }));
    map.setOptions({ styles: mapStyles });
...
var _checkoutTabs = __webpack_require__(19);

var _checkoutTabs2 = _interopRequireDefault(_checkoutTabs);
...
var $signinBtn = $('.checkout__signin'); // Клики по кнопкам внутри форм в чекауте

var $signupBtn = $('.checkout__signup');
var $recoveryBtn = $('.checkout__recovery');
var $policy = $('.checkout__policy-link');

// Клик по "Войти в аккаунт" внутри чекаута
$signinBtn.on('click', function () {
  _checkoutTabs2.default.hideForms();
  _checkoutTabs2.default.showForm('login');
});

// Клик по "Зарегистрироваться" внутри чекаута
$signupBtn.on('click', function () {
  _checkoutTabs2.default.hideForms();
  _checkoutTabs2.default.showForm('reg');
});

// Клик по "Забыли пароль" внутри чекаута
$recoveryBtn.on('click', function () {
  _checkoutTabs2.default.hideForms();
  _checkoutTabs2.default.showForm('recovery');
});

// Клик по чекбоксу "Условия соглашения"
$policy.on('click', function (e) {
  e.preventDefault();
  _checkout2.default.hideCheckout();
...
window.cart = {
  recoveryProduct: function recoveryProduct(product) {
...
var $clearBtn = $('.clear-promocode');
var $promocodeInput = $('.cart__input--promocode input');
...
var $minus = $('.counter__btn--minus');
var $plus = $('.counter__btn--plus');

var decrement = function decrementCounter(ctx) {
  var $this = $(ctx);
...
var increment = function incrementCounter(ctx) {
  var $this = $(ctx);
...
var onMinusClick = function onMinusClick() {
  var $this = $(this);
  var $parent = $this.closest('.cart__product');
  var $amountIcon = $parent.find('.cart__amount-icon');

  var value = decrement(this);
...
var $tabCourier = $('.delivery-tab--courier');
var $tabMyself = $('.delivery-tab--myself');
var $courier = $('.delivery__courier');
var $myself = $('.delivery__myself');

$tabCourier.on('click', function () {
...
var $addAddressBtn = $('.delivery__add-address');
var $new = $('.delivery__new');
var $saveAddressButtons = $('.checkout__btn--left, .checkout__btn--right');
var $sendBtn = $('.checkout__btn--send');
...
$('.checkout__btn--left').on('click', function () {
...
var $showMapBtn = $('.delivery__show-map');
var $hideMapBtn = $('.delivery__hide-map');
var $map = $('.delivery__map');
...
var $cardNew = $('.payment__card-new');
var $cardInput = $('.payment__card-input');

$cardNew.on('click', function () {
...
// Клик по карандашу
var $editDelivery = $('.confirm__edit--delivery'); // Последний этап чекаута

var $editPayment = $('.confirm__edit--payment');

$editDelivery.on('click', function () {
  _checkoutTabs2.default.hideForms();
  _checkoutTabs2.default.deactivateTabs();
  _checkoutTabs2.default.activateTab('delivery');
  _checkoutTabs2.default.showForm('delivery');
});

$editPayment.on('click', function () {
  _checkoutTabs2.default.hideForms();
  _checkoutTabs2.default.deactivateTabs();
  _checkoutTabs2.default.activateTab('payment');
  _checkoutTabs2.default.showForm('payment');
});
...
window.product = {
  setFavorite: function setFavorite(btn) {
    $(btn).addClass('is-selected');
  },
  unsetFavorite: function unsetFavorite(btn) {
...
var _isMobile = __webpack_require__(46);
...
$(document).ready(function () {
  ...
  var $items = $('.instagram__box');
  _gsap.TweenMax.set([$items], { transition: '1s ease' });
  ...
  var $inst = $('#instagram');
  var $footerDesktop = $('.footer--last.footer--desktop');
  var $footerMobile = $('.footer--last.footer--mob');
...
var Accordion = function () {
  function Accordion() {
    ...
    var $buttons = this.el.find('.accordion__btn');
  ...
  _createClass(Accordion, [{
    ...
    value: function dropdown(e) {
      ...
      $el.find('.accordion__content').not($next).slideUp().parent().removeClass('is-open');
    }
  }]);
...
$('.item .accordion:first-child').addClass('is-open').find('.accordion__content').slideDown();
...
var _hammer = __webpack_require__(59);

var _hammer2 = _interopRequireDefault(_hammer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // Кастомный слайдер для товаров

var Grabber = function Grabber(el) {
  var _this = this;
  ...
  this.initializeElements = function () {
    _this.$railMove = _this.$wrapper;
    _this.links = _this.$wrapper.find('a');
    _this.getBCR();
  };
  ...
  this.initializeEvents = function () {
    ...
    // Клики по ссылкам
    var onSliderLinkClick = function onSliderLinkClick(e) {
    ...
    _this.links.on('click', onSliderLinkClick);

    // Hammer init
    _this.panManager = new _hammer2.default.Manager(_this.$wrapper[0].parentNode);
    _this.panManager.add(new _hammer2.default.Pan({
      direction: _hammer2.default.DIRECTION_HORIZONTAL,
      threshold: 0
    }));
    _this.panManager.add(new _hammer2.default.Tap());
    _this.panManager.on('panstart', _this.onPanStart);
    _this.panManager.on('panmove', _this.onPanMove);
    _this.panManager.on('panend', _this.onPanEnd);
  };

  this.onPanStart = function () {
    _this.grabbed = !0;
    _this.preventClick = !0;
    _this.progressOnGrabStart = parseInt('' + _this.translation, 10);
  };

  this.onPanMove = function (e) {
    _this.translation = _this.progressOnGrabStart + e.deltaX;
  };

  this.onPanEnd = function () {
    _this.grabbed = !1;
    requestAnimationFrame(function () {
      _this.preventClick = !1;
    }, 10);
  };

  this.getBCR = function () {
    _this.railMoveBCR = _this.$railMove[0].getBoundingClientRect();
  ...
  this.update = function () {
    var widthResult = void 0;
    if (_this.isFullpage) {
      widthResult = _this.containerWidth;
    } else {
      widthResult = _this.railMoveBCR.width;
    }

    if (!_this.grabbed) _this.translation -= _this.velocity;

    var t = 0;
    if (_this.translation > 0) {
      t = -widthResult + _this.translation % widthResult;
    } else {
      t = _this.translation % widthResult;
    }

    _gsap.TweenMax.set(_this.$railMove, {
      x: t
    });

    _this.requestAnimation = window.requestAnimationFrame(_this.update.bind(_this));
  };
  ...
  $(window).on('resize', function () {
    if (window.innerWidth > 2000) {
      _this.productWidth = 430 + 28;
    } else if (window.innerWidth > 855) {
      _this.productWidth = (window.innerWidth / 100 * 44.5 - 14) / 2 - 14 + 28;
    } else if (window.innerWidth < 480) {
      _this.productWidth = 136 + 16;
    } else {
      _this.productWidth = 180 + 28;
    }
    _this.containerWidth = _this.productsInRow * _this.productWidth;
    _this.$wrapper.width(_this.containerWidth);
  });
...
!function (s, a, t, I) {
  ...
  var o,
      ...
      u = Math.round,
      A = Math.abs,
      _ = Date.now;function c(t, e, i) {
    return setTimeout(v(t, i), e);
  }function n(t, e, i) {
    return !!Array.isArray(t) && (l(t, i[e], i), !0);
  }function l(t, e, i) {
    var n;if (t) if (t.forEach) t.forEach(e, i);else if (t.length !== I) for (n = 0; n < t.length;) {
      e.call(i, t[n], n, t), n++;
    } else for (n in t) {
    ...
    var r = "DEPRECATED METHOD: " + t + "\n" + e + " AT \n";return function () {
      var t = new Error("get-stack-trace"),
          ...
          i = s.console && (s.console.warn || s.console.log);return i && i.call(s.console, r, e), n.apply(this, arguments);
    };
  }o = "function" != typeof Object.assign ? function (t) {
    if (t === I || null === t) throw new TypeError("Cannot convert undefined or null to object");for (var e = Object(t), i = 1; i < arguments.length; i++) {
      var n = arguments[i];if (n !== I && null !== n) for (var r in n) {
        n.hasOwnProperty(r) && (e[r] = n[r]);
      }
    }return e;
  } : Object.assign;var p = r(function (t, e, i) {
    for (var n = Object.keys(e), r = 0; r < n.length;) {
      (!i || i && t[n[r]] === I) && (t[n[r]] = e[n[r]]), r++;
    }return t;
  }, "extend", "Use `assign`."),
      f = r(function (t, e) {
    return p(t, e, !0);
  }, "merge", "Use `assign`.");function d(t, e, i) {
    var n,
        r = e.prototype;(n = t.prototype = Object.create(r)).constructor = t, n._super = r, i && o(n, i);
  }function v(t, e) {
    return function () {
      return t.apply(e, arguments);
    };
  }function m(t, e) {
    return (typeof t === "undefined" ? "undefined" : _typeof(t)) == i ? t.apply(e && e[0] || I, e) : t;
  }function g(t, e) {
    return t === I ? e : t;
  }function T(e, t, i) {
    l(S(t), function (t) {
    ...
    for (var n = [], r = [], s = 0; s < t.length;) {
      var o = i ? t[s][i] : t[s];b(r, o) < 0 && n.push(t[s]), r[s] = o, s++;
    }return e && (n = i ? n.sort(function (t, e) {
      return t[i] > e[i];
    }) : n.sort()), n;
  }function x(t, e) {
    for (var i, n, r = e[0].toUpperCase() + e.slice(1), s = 0; s < h.length;) {
      if ((n = (i = h[s]) ? i + r : e) in t) return n;s++;
    }return I;
  }var w = 1;function O(t) {
    var e = t.ownerDocument || t;return e.defaultView || e.parentWindow || s;
  }var R = "ontouchstart" in s,
      M = x(s, "PointerEvent") !== I,
      ...
      Z = j | G,
      B = ["x", "y"],
      $ = ["clientX", "clientY"];function J(e, t) {
    var i = this;this.manager = e, this.callback = t, this.element = e.element, this.target = e.options.inputTarget, this.domHandler = function (t) {
      m(e.options.enable, [e]) && i.handler(t);
    }, this.init();
  }function K(t, e, i) {
    var n = i.pointers.length,
        r = i.changedPointers.length,
        s = e & F && n - r == 0,
        o = e & (W | q) && n - r == 0;i.isFirst = !!s, i.isFinal = !!o, s && (t.session = {}), i.eventType = e, function (t, e) {
      var i = t.session,
          n = e.pointers,
          r = n.length;i.firstInput || (i.firstInput = Q(e)), 1 < r && !i.firstMultiple ? i.firstMultiple = Q(e) : 1 === r && (i.firstMultiple = !1);var s,
          o,
          a,
          h,
          u,
          ...
          l = i.firstInput,
          p = i.firstMultiple,
          f = p ? p.center : l.center,
          d = e.center = tt(n);e.timeStamp = _(), e.deltaTime = e.timeStamp - l.timeStamp, e.angle = rt(f, d), e.distance = nt(f, d), s = i, a = (o = e).center, h = s.offsetDelta || {}, u = s.prevDelta || {}, c = s.prevInput || {}, o.eventType !== F && c.eventType !== W || (u = s.prevDelta = { x: c.deltaX || 0, y: c.deltaY || 0 }, h = s.offsetDelta = { x: a.x, y: a.y }), o.deltaX = u.x + (a.x - h.x), o.deltaY = u.y + (a.y - h.y), e.offsetDirection = it(e.deltaX, e.deltaY);var v,
          m,
          g,
          T,
          y = et(e.deltaTime, e.deltaX, e.deltaY);e.overallVelocityX = y.x, e.overallVelocityY = y.y, e.overallVelocity = A(y.x) > A(y.y) ? y.x : y.y, e.scale = p ? (g = p.pointers, nt((T = n)[0], T[1], $) / nt(g[0], g[1], $)) : 1, e.rotation = p ? (v = p.pointers, rt((m = n)[1], m[0], $) + rt(v[1], v[0], $)) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, function (t, e) {
        var i,
            n,
            r,
            s,
            o = t.lastInterval || e,
            a = e.timeStamp - o.timeStamp;if (e.eventType != q && (Y < a || o.velocity === I)) {
          var h = e.deltaX - o.deltaX,
              u = e.deltaY - o.deltaY,
              c = et(a, h, u);n = c.x, r = c.y, i = A(c.x) > A(c.y) ? c.x : c.y, s = it(h, u), t.lastInterval = e;
        } else i = o.velocity, n = o.velocityX, r = o.velocityY, s = o.direction;e.velocity = i, e.velocityX = n, e.velocityY = r, e.direction = s;
      }(i, e);var E = t.element;C(e.srcEvent.target, E) && (E = e.srcEvent.target), e.target = E;
    ...
    }return { timeStamp: _(), pointers: e, center: tt(e), deltaX: t.deltaX, deltaY: t.deltaY };
  }function tt(t) {
    var e = t.length;if (1 === e) return { x: u(t[0].clientX), y: u(t[0].clientY) };for (var i = 0, n = 0, r = 0; r < e;) {
      i += t[r].clientX, n += t[r].clientY, r++;
    }return { x: u(i / e), y: u(n / e) };
  }function et(t, e, i) {
    return { x: e / t || 0, y: i / t || 0 };
  }function it(t, e) {
    return t === e ? k : A(t) >= A(e) ? t < 0 ? H : L : e < 0 ? U : V;
  }function nt(t, e, i) {
    i || (i = B);var n = e[i[0]] - t[i[0]],
        r = e[i[1]] - t[i[1]];return Math.sqrt(n * n + r * r);
  }function rt(t, e, i) {
    i || (i = B);var n = e[i[0]] - t[i[0]],
        r = e[i[1]] - t[i[1]];return 180 * Math.atan2(r, n) / Math.PI;
  }J.prototype = { handler: function handler() {}, init: function init() {
    ...
    } };var st = { mousedown: F, mousemove: 2, mouseup: W },
      ot = "mousedown",
      at = "mousemove mouseup";function ht() {
    this.evEl = ot, this.evWin = at, this.pressed = !1, J.apply(this, arguments);
  }d(ht, J, { handler: function handler(t) {
      var e = st[t.type];e & F && 0 === t.button && (this.pressed = !0), 2 & e && 1 !== t.which && (e = W), this.pressed && (e & W && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: X, srcEvent: t }));
    } });var ut = { pointerdown: F, pointermove: 2, pointerup: W, pointercancel: q, pointerout: q },
      ct = { 2: N, 3: "pen", 4: X, 5: "kinect" },
      lt = "pointerdown",
      pt = "pointermove pointerup pointercancel";function ft() {
    this.evEl = lt, this.evWin = pt, J.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
  }s.MSPointerEvent && !s.PointerEvent && (lt = "MSPointerDown", pt = "MSPointerMove MSPointerUp MSPointerCancel"), d(ft, J, { handler: function handler(t) {
      var e = this.store,
          i = !1,
          ...
          o = s == N,
          a = b(e, t.pointerId, "pointerId");r & F && (0 === t.button || o) ? a < 0 && (e.push(t), a = e.length - 1) : r & (W | q) && (i = !0), a < 0 || (e[a] = t, this.callback(this.manager, r, { pointers: e, changedPointers: [t], pointerType: s, srcEvent: t }), i && e.splice(a, 1));
    } });var dt = { touchstart: F, touchmove: 2, touchend: W, touchcancel: q },
      vt = "touchstart",
      mt = "touchstart touchmove touchend touchcancel";function gt() {
    this.evTarget = vt, this.evWin = mt, this.started = !1, J.apply(this, arguments);
  }d(gt, J, { handler: function handler(t) {
      var e = dt[t.type];if (e === F && (this.started = !0), this.started) {
        var i = function (t, e) {
          var i = P(t.touches),
              n = P(t.changedTouches);return e & (W | q) && (i = D(i.concat(n), "identifier", !0)), [i, n];
        }.call(this, t, e);e & (W | q) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: N, srcEvent: t });
      }
    } });var Tt = { touchstart: F, touchmove: 2, touchend: W, touchcancel: q },
      yt = "touchstart touchmove touchend touchcancel";function Et() {
    this.evTarget = yt, this.targetIds = {}, J.apply(this, arguments);
  }d(Et, J, { handler: function handler(t) {
      var e = Tt[t.type],
          i = function (t, e) {
        var i = P(t.touches),
            n = this.targetIds;if (e & (2 | F) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];var r,
            s,
            o = P(t.changedTouches),
            a = [],
            h = this.target;if (s = i.filter(function (t) {
          return C(t.target, h);
        }), e === F) for (r = 0; r < s.length;) {
          n[s[r].identifier] = !0, r++;
        }for (r = 0; r < o.length;) {
          n[o[r].identifier] && a.push(o[r]), e & (W | q) && delete n[o[r].identifier], r++;
        }return a.length ? [D(s.concat(a), "identifier", !0), a] : void 0;
      }.call(this, t, e);i && this.callback(this.manager, e, { pointers: i[0], changedPointers: i[1], pointerType: N, srcEvent: t });
    } });var It = 2500;function At() {
    J.apply(this, arguments);var t = v(this.handler, this);this.touch = new Et(this.manager, t), this.mouse = new ht(this.manager, t), this.primaryTouch = null, this.lastTouches = [];
  }function _t(t) {
    var e = t.changedPointers[0];if (e.identifier === this.primaryTouch) {
      var i = { x: e.clientX, y: e.clientY };this.lastTouches.push(i);var n = this.lastTouches;setTimeout(function () {
        var t = n.indexOf(i);-1 < t && n.splice(t, 1);
      }, It);
    }
  }d(At, J, { handler: function handler(t, e, i) {
      var n = i.pointerType == N,
          r = i.pointerType == X;if (!(r && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
        if (n) (function (t, e) {
          t & F ? (this.primaryTouch = e.changedPointers[0].identifier, _t.call(this, e)) : t & (W | q) && _t.call(this, e);
        }).call(this, e, i);else if (r && function (t) {
          for (var e = t.srcEvent.clientX, i = t.srcEvent.clientY, n = 0; n < this.lastTouches.length; n++) {
            var r = this.lastTouches[n],
                s = Math.abs(e - r.x),
                o = Math.abs(i - r.y);if (s <= 25 && o <= 25) return !0;
          }return !1;
        }.call(this, i)) return;this.callback(t, e, i);
      }
    }, destroy: function destroy() {
      this.touch.destroy(), this.mouse.destroy();
    } });var Ct = x(e.style, "touchAction"),
      St = Ct !== I,
      bt = "compute",
      Pt = "manipulation",
      Dt = "none",
      ...
      wt = "pan-y",
      Ot = function () {
    if (!St) return !1;var e = {},
        i = s.CSS && s.CSS.supports;return ["auto", "manipulation", "pan-y", "pan-x", "pan-x pan-y", "none"].forEach(function (t) {
      e[t] = !i || s.CSS.supports("touch-action", t);
    }), e;
  }();function Rt(t, e) {
    this.manager = t, this.set(e);
  }Rt.prototype = { set: function set(t) {
      t == bt && (t = this.compute()), St && this.manager.element.style && Ot[t] && (this.manager.element.style[Ct] = t), this.actions = t.toLowerCase().trim();
      ...
      var e = [];return l(this.manager.recognizers, function (t) {
        ...
        if (E(t, Dt)) return Dt;var e = E(t, xt),
            i = E(t, wt);return e && i ? Dt : e || i ? e ? xt : wt : E(t, Pt) ? Pt : "auto";
      }(e.join(" "));
    }, preventDefaults: function preventDefaults(t) {
      var e = t.srcEvent,
          i = t.offsetDirection;if (this.manager.session.prevented) e.preventDefault();else {
        var n = this.actions,
            r = E(n, Dt) && !Ot[Dt],
            s = E(n, wt) && !Ot[wt],
            o = E(n, xt) && !Ot[xt];if (r) {
          var a = 1 === t.pointers.length,
              h = t.distance < 2,
              u = t.deltaTime < 250;if (a && h && u) return;
      ...
      Yt = Xt,
      Ft = 16;function Wt(t) {
    this.options = o({}, this.defaults, t || {}), this.id = w++, this.manager = null, this.options.enable = g(this.options.enable, !0), this.state = Mt, this.simultaneous = {}, this.requireFail = [];
  }function qt(t) {
    ...
    return (e = e || {}).recognizers = g(e.recognizers, $t.defaults.preset), new Jt(t, e);
  }function Jt(t, e) {
    var i;this.options = o({}, $t.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = new ((i = this).options.inputClass || (M ? ft : z ? Et : R ? At : ht))(i, K), this.touchAction = new Rt(this, this.options.touchAction), Kt(this, !0), l(this.options.recognizers, function (t) {
      var e = this.add(new t[0](t[1]));t[2] && e.recognizeWith(t[2]), t[3] && e.requireFailure(t[3]);
    }, this);
  }function Kt(i, n) {
    var r,
        s = i.element;s.style && (l(i.options.cssProps, function (t, e) {
      r = x(s.style, e), n ? (i.oldCssProps[r] = s.style[r], s.style[r] = t) : s.style[r] = i.oldCssProps[r] || "";
    }), n || (i.oldCssProps = {}));
  }Wt.prototype = { defaults: {}, set: function set(t) {
      return o(this.options, t), this.manager && this.manager.touchAction.update(), this;
    }, recognizeWith: function recognizeWith(t) {
      if (n(t, "recognizeWith", this)) return this;var e = this.simultaneous;return e[(t = Ht(t, this)).id] || (e[t.id] = t).recognizeWith(this), this;
    }, dropRecognizeWith: function dropRecognizeWith(t) {
      return n(t, "dropRecognizeWith", this) || (t = Ht(t, this), delete this.simultaneous[t.id]), this;
    }, requireFailure: function requireFailure(t) {
      if (n(t, "requireFailure", this)) return this;var e = this.requireFail;return -1 === b(e, t = Ht(t, this)) && (e.push(t), t.requireFailure(this)), this;
    }, dropRequireFailure: function dropRequireFailure(t) {
      if (n(t, "dropRequireFailure", this)) return this;t = Ht(t, this);var e = b(this.requireFail, t);return -1 < e && this.requireFail.splice(e, 1), this;
      ...
      var i = this,
          t = this.state;function n(t) {
        i.manager.emit(t, e);
      }t < Xt && n(i.options.event + qt(t)), n(i.options.event), e.additionalEvent && n(e.additionalEvent), Xt <= t && n(i.options.event + qt(t));
    }, tryEmit: function tryEmit(t) {
      if (this.canEmit()) return this.emit(t);this.state = 32;
    }, canEmit: function canEmit() {
      for (var t = 0; t < this.requireFail.length;) {
        if (!(this.requireFail[t].state & (32 | Mt))) return !1;t++;
      }return !0;
    }, recognize: function recognize(t) {
      var e = o({}, t);if (!m(this.options.enable, [this, e])) return this.reset(), void (this.state = 32);this.state & (Yt | Ft | 32) && (this.state = Mt), this.state = this.process(e), this.state & (zt | Nt | Xt | Ft) && this.tryEmit(e);
    }, process: function process(t) {}, getTouchAction: function getTouchAction() {}, reset: function reset() {} }, d(Lt, Wt, { defaults: { pointers: 1 }, attrTest: function attrTest(t) {
      var e = this.options.pointers;return 0 === e || t.pointers.length === e;
    }, process: function process(t) {
      var e = this.state,
          i = t.eventType,
          n = e & (zt | Nt),
          r = this.attrTest(t);return n && (i & q || !r) ? e | Ft : n || r ? i & W ? e | Xt : e & zt ? e | Nt : zt : 32;
    } }), d(Ut, Lt, { defaults: { event: "pan", threshold: 10, pointers: 1, direction: Z }, getTouchAction: function getTouchAction() {
      var t = this.options.direction,
          e = [];return t & j && e.push(wt), t & G && e.push(xt), e;
      ...
      var e = this.options,
          ...
          r = t.direction,
          s = t.deltaX,
          o = t.deltaY;return r & e.direction || (e.direction & j ? (r = 0 === s ? k : s < 0 ? H : L, i = s != this.pX, n = Math.abs(t.deltaX)) : (r = 0 === o ? k : o < 0 ? U : V, i = o != this.pY, n = Math.abs(t.deltaY))), t.direction = r, i && n > e.threshold && r & e.direction;
      ...
      this.pX = t.deltaX, this.pY = t.deltaY;var e = kt(t.direction);e && (t.additionalEvent = this.options.event + e), this._super.emit.call(this, t);
    } }), d(Vt, Lt, { defaults: { event: "pinch", threshold: 0, pointers: 2 }, getTouchAction: function getTouchAction() {
      return [Dt];
    }, attrTest: function attrTest(t) {
    ...
    } }), d(jt, Wt, { defaults: { event: "press", pointers: 1, time: 251, threshold: 9 }, getTouchAction: function getTouchAction() {
      return ["auto"];
    }, process: function process(t) {
      var e = this.options,
          i = t.pointers.length === e.pointers,
          n = t.distance < e.threshold,
          r = t.deltaTime > e.time;if (this._input = t, !n || !i || t.eventType & (W | q) && !r) this.reset();else if (t.eventType & F) this.reset(), this._timer = c(function () {
        this.state = Yt, this.tryEmit();
      }, e.time, this);else if (t.eventType & W) return Yt;return 32;
    }, reset: function reset() {
      clearTimeout(this._timer);
    }, emit: function emit(t) {
      this.state === Yt && (t && t.eventType & W ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = _(), this.manager.emit(this.options.event, this._input)));
    } }), d(Gt, Lt, { defaults: { event: "rotate", threshold: 0, pointers: 2 }, getTouchAction: function getTouchAction() {
      return [Dt];
    }, attrTest: function attrTest(t) {
      return this._super.attrTest.call(this, t) && (Math.abs(t.rotation) > this.options.threshold || this.state & zt);
    } }), d(Zt, Lt, { defaults: { event: "swipe", threshold: 10, velocity: .3, direction: j | G, pointers: 1 }, getTouchAction: function getTouchAction() {
      return Ut.prototype.getTouchAction.call(this);
    }, attrTest: function attrTest(t) {
      var e,
          i = this.options.direction;return i & (j | G) ? e = t.overallVelocity : i & j ? e = t.overallVelocityX : i & G && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && A(e) > this.options.velocity && t.eventType & W;
    }, emit: function emit(t) {
      var e = kt(t.offsetDirection);e && this.manager.emit(this.options.event + e, t), this.manager.emit(this.options.event, t);
    } }), d(Bt, Wt, { defaults: { event: "tap", pointers: 1, taps: 1, interval: 300, time: 250, threshold: 9, posThreshold: 10 }, getTouchAction: function getTouchAction() {
      return [Pt];
    }, process: function process(t) {
      var e = this.options,
          i = t.pointers.length === e.pointers,
          n = t.distance < e.threshold,
          r = t.deltaTime < e.time;if (this.reset(), t.eventType & F && 0 === this.count) return this.failTimeout();if (n && r && i) {
        if (t.eventType != W) return this.failTimeout();var s = !this.pTime || t.timeStamp - this.pTime < e.interval,
            o = !this.pCenter || nt(this.pCenter, t.center) < e.posThreshold;if (this.pTime = t.timeStamp, this.pCenter = t.center, o && s ? this.count += 1 : this.count = 1, this._input = t, 0 == this.count % e.taps) return this.hasRequireFailures() ? (this._timer = c(function () {
          this.state = Yt, this.tryEmit();
    ...
    } }), $t.VERSION = "2.0.7", $t.defaults = { domEvents: !1, touchAction: bt, enable: !0, inputTarget: null, inputClass: null, preset: [[Gt, { enable: !1 }], [Vt, { enable: !1 }, ["rotate"]], [Zt, { direction: j }], [Ut, { direction: j }, ["swipe"]], [Bt], [Bt, { event: "doubletap", taps: 2 }, ["tap"]], [jt]], cssProps: { userSelect: "none", touchSelect: "none", touchCallout: "none", contentZooming: "none", userDrag: "none", tapHighlightColor: "rgba(0,0,0,0)" } }, Jt.prototype = { set: function set(t) {
      ...
      var e = this.session;if (!e.stopped) {
        var i;this.touchAction.preventDefaults(t);var n = this.recognizers,
            r = e.curRecognizer;(!r || r && r.state & Yt) && (r = e.curRecognizer = null);for (var s = 0; s < n.length;) {
          i = n[s], 2 === e.stopped || r && i != r && !i.canRecognizeWith(r) ? i.reset() : i.recognize(t), !r && i.state & (zt | Nt | Xt) && (r = e.curRecognizer = i), s++;
        }
      }
    }, get: function get(t) {
      if (t instanceof Wt) return t;for (var e = this.recognizers, i = 0; i < e.length; i++) {
        if (e[i].options.event == t) return e[i];
      }return null;
    }, add: function add(t) {
      if (n(t, "add", this)) return this;var e = this.get(t.options.event);return e && this.remove(e), this.recognizers.push(t), (t.manager = this).touchAction.update(), t;
    }, remove: function remove(t) {
      if (n(t, "remove", this)) return this;if (t = this.get(t)) {
        var e = this.recognizers,
            i = b(e, t);-1 !== i && (e.splice(i, 1), this.touchAction.update());
      }return this;
    }, on: function on(t, e) {
      if (t !== I && e !== I) {
        var i = this.handlers;return l(S(t), function (t) {
          i[t] = i[t] || [], i[t].push(e);
        }), this;
      }
      ...
      var i, n, r;this.options.domEvents && (i = t, n = e, (r = a.createEvent("Event")).initEvent(i, !0, !0), (r.gesture = n).target.dispatchEvent(r));var s = this.handlers[t] && this.handlers[t].slice();if (s && s.length) {
    ...
    } }, o($t, { INPUT_START: F, INPUT_MOVE: 2, INPUT_END: W, INPUT_CANCEL: q, STATE_POSSIBLE: Mt, STATE_BEGAN: zt, STATE_CHANGED: Nt, STATE_ENDED: Xt, STATE_RECOGNIZED: Yt, STATE_CANCELLED: Ft, STATE_FAILED: 32, DIRECTION_NONE: k, DIRECTION_LEFT: H, DIRECTION_RIGHT: L, DIRECTION_UP: U, DIRECTION_DOWN: V, DIRECTION_HORIZONTAL: j, DIRECTION_VERTICAL: G, DIRECTION_ALL: Z, Manager: Jt, Input: J, TouchAction: Rt, TouchInput: Et, MouseInput: ht, PointerEventInput: ft, TouchMouseInput: At, SingleTouchInput: gt, Recognizer: Wt, AttrRecognizer: Lt, Tap: Bt, Pan: Ut, Swipe: Zt, Pinch: Vt, Rotate: Gt, Press: jt, on: T, off: y, each: l, merge: f, extend: p, assign: o, inherit: d, bindFn: v, prefixed: x }), (void 0 !== s ? s : "undefined" != typeof self ? self : {}).Hammer = $t,  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return $t;
  }).call(exports, __webpack_require__, exports, module),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : "undefined" != typeof module && module.exports ? module.exports = $t : s.Hammer = $t;
}(window, document);
...
var $btn = $('.item__btn--cart');
var $btns = $('.item__btns');
var $btnClose = $('.item__sizes-overlay');
var $sizes = $('.item__sizes-mob');
var $sizeLabel = $sizes.find('.item__size');

var showMobSizes = function showMobSizes() {
  _stopScroll2.default.disable();
  $btns.removeClass('is-visible');
  $sizes.addClass('is-active');
};
var hideMobSizes = function hideMobSizes() {
  _stopScroll2.default.enable();
...
var incrementCart = function incrementCart() {
  $('.header__cart').addClass('header__cart--fill');

  var $counter = $('.header__cart-num');
  var value = +$counter.first().text();
  var newValue = value + 1;
...
$sizeLabel.on('click', function onSizeLabelClick() {
  ...
  setTimeout(function () {
    $(_this).removeClass('item__size--is-active');
    hideMobSizes();
    // incrementCart();
  }, 300);
});
...
window.sizes = {
  open: showMobSizes,
  close: hideMobSizes,
  animateLabel: function animateLabel(label, callback) {
...
exports.default = { hideMobSizes: hideMobSizes, showMobSizes: showMobSizes };
...
var _itemImage = __webpack_require__(89);
...
// Pepper-слайдер
var $images = $('.item__left .item__images--mob li');
var $thumbs = $('.item__left .item__thumbs--mob li');

var slider = $('.item__left .item__images--mob').Peppermint({
  mouseDrag: _isMobile2.default,
  speed: 400,
  touchSpeed: 400,
...
$images.on('click', _itemImage2.default.modalImage.openModal);
...
var $thumbsModal = $('.item-modal .item__thumbs--mob li');

var sliderModal = $('.item-modal .item__images--mob').Peppermint({
  speed: 400,
  touchSpeed: 400,
  onSetup: function onSetup() {
...
exports.default = { sliderModal: sliderModal, slider: slider };
...
var _sizesMobile = __webpack_require__(61);

var _sizesMobile2 = _interopRequireDefault(_sizesMobile);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var $mysize = $('.mysize');
var $mysizeBtn = $('.item__mysize');
var $mysizeClose = $('.mysize__close, .mysize__overlay');

var hideMysize = function hideMysize() {
  _stopScroll2.default.enable();
  $mysize.removeClass('mysize--is-visible');
  $mysizeClose.off('click', hideMysize);
};
var showMysize = function showMysize() {
  _sizesMobile2.default.hideMobSizes();
  _stopScroll2.default.disable();
...
exports.default = { showMysize: showMysize, hideMysize: hideMysize };
...
var $sizeguideBtn = $('.item__all-size');
var $sizeguideClose = $sizeguide.find('.sizeguide__close, .sizeguide__overlay');

var hideSizeguide = function hideSizeguide() {
  _stopScroll2.default.enable();
  $sizeguide.removeClass('sizeguide--is-visible');
  $sizeguideClose.off('click', hideSizeguide);
};
var showSizeguide = function showSizeguide() {
  _sizesMobile2.default.hideMobSizes();
  _stopScroll2.default.disable();
...
exports.default = { showSizeguide: showSizeguide, hideSizeguide: hideSizeguide };
...
document.querySelector('html').classList.add('page-item');
...
function Peppermint(a, b) {
  function c(a, b) {
    ...
    var b = ["Webkit", "Moz", "O", "ms"],
        c = document.createElement("div");if (void 0 !== c.style[a]) return !0;a = a.charAt(0).toUpperCase() + a.slice(1);for (var d in b) {
    ...
    0 > a ? a = 0 : a > v - 1 && (a = v - 1);for (var c = C.dots.length - 1; c >= 0; c--) {
      f(C.dots[c], G.activeDot);
    ...
    C.width = a.offsetWidth, y.style.width = C.width * v + "px";for (var b = 0; v > b; b++) {
      C.slides[b].style.width = C.width + "px";
    }h(-E * C.width);
  }function s(a, b, c, d) {
    ...
    var b = F.slidesContainer || a,
      ...
      }v = C.slides.length, w = 100 / v, e(a, G.active), f(a, G.inactive), F.mouseDrag && e(a, G.mouse), C.width = a.offsetWidth, y.style.width = C.width * v + "px";for (var d = 0; v > d; d++) {
        C.slides[d].style.width = C.width + "px", y.appendChild(C.slides[d]);
      }if (F.slidesContainer || a.appendChild(y), F.dots && v > 1) {
        x = document.createElement("ul"), e(x, G.dots);for (var d = 0, l = C.dots.length; l > d; d++) {
          x.appendChild(C.dots[d]);
      ...
      H = { transforms: d("transform"), transitions: d("transition") };return u(), { slideTo: function slideTo(a, b) {
...
var _ImageSlider = __webpack_require__(90);

var _ImageSlider2 = _interopRequireDefault(_ImageSlider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var $images = $('.item .item__image-wrap');
var $thumbs = $('.item .item__thumb-btn');

var $imagesModal = $('.item-modal .item__image-wrap');
var $thumbsModal = $('.item-modal .item__thumb-btn');

var modalImage = new _ImageSlider2.default($imagesModal, $thumbsModal);
var itemImage = new _ImageSlider2.default($images, $thumbs, $images);

itemImage.connectWith(modalImage);
modalImage.connectWith(itemImage);

exports.default = { modalImage: modalImage, itemImage: itemImage };
...
var _pepper = __webpack_require__(62);

var _pepper2 = _interopRequireDefault(_pepper);
...
var ImageSlider = function ImageSlider($images, $thumbs, $openModal) {
  var _this = this;

  _classCallCheck(this, ImageSlider);

  this.showImg = function () {
    return $(_this.images[_this.i]).addClass('is-active');
  };

  this.hideImages = function () {
    return _this.images.removeClass('is-active');
  };

  this.activateThumb = function () {
    return $(_this.thumbs[_this.i]).addClass('is-active');
  };

  this.deactivateThumbs = function () {
    return _this.thumbs.removeClass('is-active');
  };

  this.slide = function () {
    _this.hideImages();
    _this.deactivateThumbs();
    _this.showImg();
    _this.activateThumb();
  };

  this.openModal = function () {
    _pepper2.default.sliderModal.data('Peppermint').recalcWidth();
    _stopScroll2.default.disable();

    if (_this.modal) {
      _this.modal.addClass('is-visible');
    } else {
  ...
  this.closeModal = function () {
    _stopScroll2.default.enable();
    _this.modal.removeClass('is-visible');
  };

  this.connectWith = function (Image) {
    _this.otherImage = Image;
  };
...
var _Grabber = __webpack_require__(58);
...
$(document).ready(function () {
  ...
  if ($('html').hasClass('page-item') && $('.products__content--likely .product').length >= 4) {
    $('.products__content--likely').clone().addClass('products__content--is-clone').insertAfter('.products__content--likely');
    var grLikely = new _Grabber2.default($('.products__content--likely'));
  }

  // Переключение по табам
  var $likelyTab = $('.item-tab--likely');
  var $viewedTab = $('.item-tab--viewed');

  var $likely = $('.products__content--likely');
  var $viewed = $('.products__content--viewed');

  $likelyTab.on('click', function () {
...
var $text = $('.item__color-text');
var $links = $('.item__color');

var currentText = $('.item__color--current').attr('data-color');
...
$(window).on('scroll', function () {
  ...
  var tabsTop = $('.item-tabs').offset().top;
...
// Анимация при заходе
var $item = $('.item__left, .item__info');
$(window).on('load', function () {
  setTimeout(function () {
...
var $oneclickBtn = $('.item__btn--one');
var $oneclickClose = $oneclick.find('.oneclick__close, .oneclick__overlay');

var hideOneclick = function hideOneclick() {
  _stopScroll2.default.enable();
  $oneclick.removeClass('oneclick--is-visible');
  $oneclickClose.off('click', hideOneclick);
};
var showOneclick = function showOneclick() {
  _stopScroll2.default.disable();
...
exports.default = { showOneclick: showOneclick, hideOneclick: hideOneclick };
...
var $tabs = $('.sizeguide__tab');
var $forms = $('.sizeguide__form');
...
var showForm = function showForm(form) {
  return $('.sizeguide__form--' + form).addClass('sizeguide__form--is-active');
};
...
var activateTab = function activateTab(type) {
  return $('.sizeguide__tab--' + type).addClass('sizeguide__tab--is-active');
};
...
exports.default = { hideForms: hideForms, showForm: showForm, deactivateTabs: deactivateTabs, activateTab: activateTab };
...
var _sizeguide = __webpack_require__(64);

var _sizeguide2 = _interopRequireDefault(_sizeguide);

var _mysize = __webpack_require__(63);

var _mysize2 = _interopRequireDefault(_mysize);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// Клики по кнопкам внутри форм в сайзгайда

var $mysizeBtn = $('.sizeguide__btn, .sizeguide__mysize');

$mysizeBtn.on('click', function () {
  _sizeguide2.default.hideSizeguide();
  _mysize2.default.showMysize();
});
...
var $success = $('.success'); // Анимация и показ всего success

var $successClose = $success.find('.success__close, .success__overlay');
...
exports.default = { showSuccess: showSuccess, hideSuccess: hideSuccess };
