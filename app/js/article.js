...
document.querySelector('html').classList.add('page-article');
...
var $child = $('.article-side__drop .article-side__link');
$child.on('click', function (e) {
  e.originalEvent.cancelBubble = true;
});

// Клик/ховер по иконке "Больше"
var $moreBtn = $('.article-side__link--more');
var onClick = function onMoreClick() {
  $moreBtn.mouseleave();
};
