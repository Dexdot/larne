...
document.querySelector('html').classList.add('page-profile');
...
var showForm = function showForm(type) {
  _stopScroll2.default.disable();
  $('.profile__block--' + type + ' .profile-form').addClass('profile-form--is-visible');
};

var showFormExt = function showFormExt(type, id) {
  _stopScroll2.default.disable();
  $('.profile__block--' + type + ' .profile-form[data-form=' + id + ']').addClass('profile-form--is-visible');
};

// Открытие форм
var $tabs = $('.profile__container [data-profile]');
$tabs.on('click', function onProfileCardClick() {
  hideForms();
  var type = this.dataset.profile;
...
// Закрытие форм
var $closeBtn = $('.profile-form__overlay, .profile-form__close');
...
var $tabs = $('.profile__tab');
var $profiles = $('.profile__block');

var deactivateTabs = function deactivateTabs() {
  return $tabs.removeClass('profile__tab--is-active');
};
var activateTab = function activateTab(tab) {
  return $(tab).addClass('profile__tab--is-active');
};

var hideProfiles = function hideProfiles() {
  return $profiles.hide();
};
var showProfile = function showProfile(type) {
  return $('.profile__block--' + type).show();
};
...
exports.default = { deactivateTabs: deactivateTabs, activateTab: activateTab, hideProfiles: hideProfiles, showProfile: showProfile };
